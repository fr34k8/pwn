...
# This Metasploit RC-File could be used to automate the brutef.rbe process
...
# WARNING: You could lock out users with this reso.rbe script!
...
framework.db.hosts.each do |host|
	host.services.each do |serv|
		...
		# for now we only brute f.rbe these services, you can add some more ...
