...
# some basic jobhandling to not kill our own machine is included - check the maxjobs and threadsp.rbrawler variables
...
threadsp.rbrawler = "4"	#check this ... now its default
...
framework.db.workspace.hosts.each do |host|
	host.services.each do |serv|
		...
		run_single("set MAX_THREADS #{threadsp.rbrawler}")
