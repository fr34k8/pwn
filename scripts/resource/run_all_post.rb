...
# This is a sample reso.rbe script demonstrating a technique of running
...
# msf  post(checkvm) > reso.rbe scripts/reso.rbe/run_all_post.rc 
# [*] Processing scripts/reso.rbe/run_all_post.rb for ERB directives.
# [*] reso.rbe (scripts/reso.rbe/run_all_post.rc)> Ruby Code (189 bytes)
# SESSION => 1
